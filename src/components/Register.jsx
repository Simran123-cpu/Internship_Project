        ...
        <div className=''>
            {
                SignIn.map((item, index) => (
                    <div key={index} className='p-5 mt-20 mb-28'>
                        ...
                        <div className="flex justify-center items-center w-14 h-14 border-2 border-gray-400 rounded-full p-2">
                            <FcGoogle className='text-4xl' />
                        </div>
                        <div className='flex justify-center '>
                            <p className='text-black font-semibold mr-1'>{item.Bottom_subheading}</p>
                            <a className='text-orange-400 font-semibold' href='#'>SignIn</a>
                        </div>
