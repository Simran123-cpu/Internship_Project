        ...
        <div>
            {LoginInfo.map((item, index) => (
                <div key={index} className='p-5 mt-10 mb-5'>
                    ...
                    <input className='border-solid border-2 border-gray mb-5'
                        type='email'
                        placeholder='Enter Email'
                    />
                    <p className='mb-2'>Password</p>
                    <div className='flex'>
                        <input className='border-solid border-2 border-gray'
                            type='password'
                    ...
                    <div className="flex justify-center items-center w-14 h-14 border-2 border-gray-400 rounded-full p-2 mt-3 mb-5">
